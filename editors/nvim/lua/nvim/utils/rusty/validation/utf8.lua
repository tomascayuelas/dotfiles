...
function factory.utf8upper()
    return function(value)
        local t = type(value)
        if t == 'string' then return true, u.utf8toupper(value) end
        return false
    end
end
function factory.utf8lower()
    return function(value)
        local t = type(value)
        if t == 'string' then return true, u.utf8tolower(value) end
        return false
    end
end
function factory.utf8title()
    return function(value)
        local t = type(value)
        if t == 'string' then return true, u.utf8title(value) end
        return false
    end
end
function factory.utf8normalize(form)
    return function(value)
        local t = type(value)
        if t == 'string' then return true, u.utf8normalize(value, form) end
        return false
    end
end
function factory.utf8category(category)
    return function(value)
        local t = type(value)
        if t == 'string' then return (u.utf8iscategory(value, category)) end
        return false
    end
end
