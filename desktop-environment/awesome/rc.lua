...
launcher = "rofi -modi run -show run -show-icons"
windowSwitcher = "rofi -modi window -show window -show-icons"
...
--    awful.key({ modkey, altkey},            "p",     function() xrandr.xrandr() end,
--              {description = "xrandr manipulation", group = "screen"}),

    awful.key({ altkey },            "Tab",     function () awful.spawn(windowSwitcher) end,
