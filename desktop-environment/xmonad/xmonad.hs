...
main = do
    xmproc0 <- spawnPipe "xmobar -x 0 ~/.config/xmobar/main"
    xmproc1 <- spawnPipe "xmobar -x 1 ~/.config/xmobar/secondary"
    xmproc2 <- spawnPipe "xmobar -x 2 ~/.config/xmobar/secondary"
...
myKeys =
    ...
    -- Windows navigation
        ...
        , ("M-S-l", windows W.swapUp)                -- Swap the focused window with the prev window
...
myManageHook = composeAll
     [
      ...
      , className =? "vlc"         --> doShift "<action=xdotool key super+5>media</action>"
